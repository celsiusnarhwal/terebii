...
| `TEREBII_REDIS_URL`        | String   | The URL of a Redis instance. If specified, Terebii will use this Redis instance instead of its integrated one. Must begin with `redis://` or `rediss://`.                                                                                                                                                               | No (unless you're using a Redis-less image) | `redis://localhost`           |
