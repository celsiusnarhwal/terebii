...
| `TEREBII_USE_URL_PARAMETER_FOR_SONARR_API_KEY` | Boolean  | If `true`, Terebii will authenticate to Sonarr by including the API key in a URL parameter rather than a header. You should leave this off unless you know you need it on.              | No            | `false`                       |
