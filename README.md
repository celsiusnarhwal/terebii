...
| `air_date`             | Date ([`datetime.datetime`](https://docs.python.org/3/library/datetime.html#datetime-objects)) | The air date of the episode in `TEREBII_TIMEZONE` (see [Configuration](#configuration)).             |
...
| `TEREBII_TIMEZONE`            | String   | An [IANA time zone identifier](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones). The `air_date` [template variable](#customizing-notifications) will be provided in this time zone.[^4]                                                                                                                    | No            | `UTC`                         |
