...
| `TEREBII_LOG_LEVEL`        | String   | The lowest level of logging messages that Terebii should print to the console. Must be one of `debug`, `info`, `warning`, or `error`.                                                                                                                                                                                   | No            | `info`                        |
