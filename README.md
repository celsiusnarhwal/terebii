...
| `air_date`        | Date ([`datetime.datetime`](https://docs.python.org/3/library/datetime.html#datetime-objects)) | The air date of the episode in `TEREBII_TIME_ZONE` (see [Configuration](#configuration)).            |
