...
| `TEREBII_TIMEZONE`            | String   | An [IANA time zone identifier](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones). The `air_date` [template variable](#customizing-notifications) will be provided in this time zone.                                                                                                                        | No            | `UTC`                         |
...
| `TEREBII_LOG_LEVEL`           | String   | The lowest level of log messages that Terebii should print to the console. Must be one of `debug`, `info`, `warning`, `error`, or `critical`.                                                                                                                                                                           | No            | `info`                        |
